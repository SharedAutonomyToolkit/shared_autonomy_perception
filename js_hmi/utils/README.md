...
#### Ubuntu
 ...
 3. Install the Grunt tasks specific to this project
   * `cd /path/to/keyboardteleopjs/utils/`
   * `npm install .`
...
#### OS X
 ...
 2. Install Grunt and the test runner [Karma](http://karma-runner.github.io/)
   * `sudo npm install -g grunt-cli karma`
 3. Install the Grunt tasks specific to this project (change /path/to to the appropriate path!)
   * `cd /path/to/robot2020_web_interface/utils/`
   * `sudo npm install .`
...
To run the build tasks:
 ...
 1. `cd /path/to/robot2020_web_interface/utils/`
 2. `grunt build`

`grunt build` will concatenate and minimize the files under src and replace robot2020lib.js and robot2020lib.min.js in the build directory. It will also run the linter and test cases. This is what [Travis CI](https://travis-ci.org/WPI-RAIL/keyboardteleopjs) runs when a Pull Request is submitted.
