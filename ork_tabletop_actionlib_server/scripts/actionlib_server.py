...
import ork_tabletop_actionlib_server.msg

class ORKTabletop(object):
  # create messages that are used to publish feedback/result
  _feedback = ork_tabletop_actionlib_server.msg.FibonacciFeedback()
  _result   = ork_tabletop_actionlib_server.msg.FibonacciResult()
